...
# If this is set to true, non-fatal warnings will make the script exit with a non-zero exit code like errors.
# shellcheck disable=SC2034
config_exit_on_warning=false

# If this is set to true, the script will exit with a non-zero exit code if non-fatal warnings were triggered, even if the script was executed fully. If config_exit_on_warning is set to true, non-fatal warnings will always make the script exit with a non-zero exit code.
# shellcheck disable=SC2034
